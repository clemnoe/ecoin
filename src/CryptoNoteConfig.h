...
namespace parameters {
  ...
  const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x0ef360; // addresses start with "intu"
  ...
  const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "ecoin-blocks.dat";
  const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "ecoin-blockindexes.dat";
  const char     CRYPTONOTE_BLOCKSCACHE_FILENAME[]             = "ecoin-blockscache.dat";
  const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "ecoin-poolstate.bin";
  const char     P2P_NET_DATA_FILENAME[]                       = "ecoin-p2pstate.bin";
  const char     CRYPTONOTE_BLOCKCHAIN_INDICES_FILENAME[]      = "ecoin-blockchainindices.dat";
  const char     MINER_CONFIG_FILE_NAME[]                      = "ecoin-miner_conf.json";
  } // parameters
...
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001904e029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101d7ad95fb61647fb1ad961ff3556fc0afc94c7cbab828eafdcd967e6465ae7b15";
